    ...
    await Swal.fire({
      ...
      didOpen: async () => {
        try {
          ...
          if (!win) return;
          win.document.write(`<html><head><title>Planilla de ingresos</title><style>@page{size:portrait;margin:8mm;}body{font-family:Inter,Arial,sans-serif;color:#1f2a44;padding:4px;background:#f7f9ff;}.sheet-header{display:flex;justify-content:space-between;align-items:stretch;gap:8px;margin-bottom:8px;}.sheet-week-block{border:1px solid #c8d4f0;border-radius:10px;background:#fff;padding:7px 10px;display:grid;align-content:center;min-width:0;}.sheet-week-label{margin:0 0 2px;color:#6073a1;font-size:10px;text-transform:uppercase;letter-spacing:.04em;}.sheet-main-week{font-size:16px;margin:0;letter-spacing:.03em;line-height:1.15;}.sheet-company-block{border:1px solid #c8d4f0;border-radius:10px;background:#fff;padding:7px 10px;line-height:1.2;display:grid;align-content:center;min-width:260px;}.sheet-company-block strong{font-size:11px;}.sheet-company-block small{font-size:9px;color:#4f628f;font-weight:700;}.sheet-entries-wrap{display:grid;gap:0;}.sheet-entry-product-wrap{display:flex;gap:6px;align-items:center;justify-content:center;min-width:0;}.sheet-entry-product-wrap-full{justify-content:flex-start;}.sheet-mini-avatar,.sheet-provider-avatar{width:25px;height:25px;border-radius:999px;border:1px solid #d2dbef;overflow:hidden;display:inline-flex;align-items:center;justify-content:center;background:#edf2ff;color:#3a5898;flex-shrink:0;}.sheet-mini-avatar img,.sheet-provider-avatar img{width:100%;height:100%;object-fit:cover;}.sheet-mini-avatar-empty{font-size:10px;}.sheet-entry-product-copy{min-width:0;text-align:center;}.sheet-entry-product-copy h3{margin:0;font-size:10px;line-height:1.1;}.sheet-provider-wrap{display:flex;gap:6px;align-items:center;justify-content:center;}.sheet-provider-avatar-fallback{font-size:10px;font-weight:800;color:#2f5db1;}.sheet-provider-copy{text-align:center;}.sheet-provider-copy strong{display:block;font-size:10px;line-height:1.1;}.sheet-provider-copy small{display:block;color:#6f7fa3;font-size:8px;line-height:1.1;}.sheet-entry-data-table{width:100%;margin-top:5px;border-collapse:collapse;table-layout:fixed;}.sheet-entry-data-table thead{display:table-header-group;}.sheet-entry-data-table th,.sheet-entry-data-table td{border:1px solid #dbe4f6;padding:4px 3px;font-size:8px;line-height:1.15;text-align:center;vertical-align:middle;}.sheet-entry-data-table th{background:#fff;color:#000;font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.02em;}.sheet-product-row td{background:#f4f7ff;font-weight:800;}.sheet-product-row .sheet-entry-product-copy h3{font-size:11px;}.sheet-entry-data-table td:nth-child(3),.sheet-entry-data-table td:nth-child(4),.sheet-entry-data-table td:nth-child(5),.sheet-entry-data-table td:nth-child(6){font-weight:700;}.sheet-manager-cell{display:grid;gap:2px;justify-items:center;}.sheet-manager-line{display:grid;line-height:1.1;}.sheet-manager-line strong{font-size:8px;}.sheet-manager-line small{font-size:7px;color:#5f7097;font-weight:700;}footer{break-inside:avoid;margin-top:8px !important;padding-top:6px !important;font-size:9px !important;line-height:1.25 !important;}</style></head><body>${weekSections}</body></html>`);
          win.document.close();
          await waitPrintAssets(win);
          win.focus();
          win.print();
  ...
  const saveEntry = async (event) => {
    ...
    try {
      ...
      if (usoInternoEmpresa) {
        ...
        entry.productionUsage = [internalUsage];
      ...
      recomputeRecordStock(record, record.stockUnit || unit);
      record.lotConfig = {
        configured: state.editorDraft.tokens.length > 0,
      ...
      didOpen: () => {
        ...
        root.addEventListener('click', async (event) => {
          ...
          if (saveBtn) {
            ...
            const infiniteExpiry = Boolean(root.querySelector('#providerRneInfiniteInput')?.checked);
            const expiryDate = infiniteExpiry ? '' : normalizeIsoDate(root.querySelector('#providerRneExpiryInput')?.value);
