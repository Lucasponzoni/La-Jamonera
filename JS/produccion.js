          ...
          <section class="recipe-step-card step-block inventario-lot-section mt-2 produccion-config-section">
            ...
            <div id="rneBody" class="step-content d-none">
              ...
              <div class="produccion-config-actions">
                ...
                <button type="button" class="btn ios-btn inventario-delete-btn inventario-threshold-btn ios-icon-btn" id="produccionDeleteRneBtn" aria-label="Eliminar RNE actual" ${(normalizeValue(currentRne.number) || normalizeValue(currentRne.attachmentUrl) || (Array.isArray(currentRne.history) && currentRne.history.length)) ? '' : 'disabled'}><i class="fa-solid fa-trash"></i></button>
              </div>
